...
| **2** | 组合视觉偏差被单纯当作表征缺陷 | 它高度接近长尾分布，可用可推导的类先验修正 —— *AAAI 2024* |
| **3** | 状态与物体被当作彼此独立的维度 | 复空间虚连接嵌入 —— *TPAMI 2025* |
| **4** | 所有错误组合被同等惩罚，无视它们与真值的亲和度 | 基于亲和类群的层次化监督 —— *Pattern Recognition 2026* |
| **5** | 未见域导致特征流形发散与语义崩溃 | 注入—丰富—校准（IMEC）—— *IJCV 2025* |
